...
class TestExtractor(unittest.TestCase):
    ...
    def test_extract_features(self, mock_parser):
        ...
        with patch('google.adk.scope.extractors.extractor_ts.Query'), \
             patch('google.adk.scope.extractors.extractor_ts.QueryCursor') as MockCursor:
            ...
            # Mock NodeProcessor
            with patch('google.adk.scope.extractors.extractor_ts.NodeProcessor') as MockProcessor:
