...
class TestNodeProcessor(unittest.TestCase):
    ...
    def test_docstring_edge_cases(self):
        ...
        def create_doc_test(doc_text, expected_desc, has_params=False):
            ...
            if has_params:
                ...
                p_node = self.create_mock_node("identifier", children=[p_name], text="x") # Simple identifier param
        ...
        res = create_doc_test('"""Desc.\n\nArguments:\n    x: X desc.\n"""', "Desc.", has_params=True)
    ...
    def test_static_method(self):
        ...
        # decorated_definition -> decorator, function_definition
        # In tree-sitter, decorated_definition children are decorators then the definition
        decorated = self.create_mock_node("decorated_definition", children=[deco, func_node], parent=class_def)
    ...
    def test_namespace_variations(self):
        ...
        # relative: custom/lib/file.py -> parent custom/lib -> parts ['custom', 'lib']
        ...
        # relative: src/other/pkg/file.py -> parent src/other/pkg -> parts [src, other, pkg] -> [other, pkg]
        ...
        # relative: src/google/adk/subpkg/__init__.py -> parent src/google/adk/subpkg
        # parts: [src, google, adk, subpkg] -> [subpkg] (after stripping src, google, adk)
        # self.assertEqual(ns4, "subpkg")
        # WAIT: logic in _extract_namespace:
        # if len(parts) >= 2 and parts[0] == 'google' and parts[1] == 'adk': parts=parts[2:]
        # So "subpkg" remains.
        # Then join.
        self.assertEqual(ns4, "subpkg")
    ...
    def test_docstring_extended(self):
        ...
        expr = self.create_mock_node("expression_statement", children=[string_node])
        ...
        node.child_by_field_name.side_effect = lambda n: name if n=='name' else (body if n=='body' else None)
        ...
        # x = 1
        assign = self.create_mock_node("assignment") # not expression_statement with string
        body.children = [assign, expr] # expression statement after assignment is NOT docstring
