...
from google.adk.scope.extractors.python.extractor import find_python_files, extract_features, main  # noqa: E402
...
class TestExtractor(unittest.TestCase):
    ...
    @patch('google.adk.scope.extractors.python.extractor.extract_features')
    ...
    @patch('google.adk.scope.extractors.python.extractor.parse_args')
    @patch('google.adk.scope.extractors.python.extractor.extract_features')
    @patch('google.adk.scope.extractors.python.extractor.find_python_files')
    @patch('builtins.open', new_callable=MagicMock)
    @patch('google.adk.scope.extractors.python.extractor.pathlib.Path.exists')
    ...
    @patch('google.adk.scope.extractors.python.extractor.parse_args')
    @patch('google.adk.scope.extractors.python.extractor.extract_features', return_value=[])
    @patch('builtins.open', new_callable=MagicMock)
    @patch('google.adk.scope.extractors.python.extractor.pathlib.Path.exists', return_value=True)
    ...
    @patch('google.adk.scope.extractors.python.extractor.parse_args')
    @patch('google.adk.scope.extractors.python.extractor.extract_features', return_value=[Feature(original_name="f")])
    @patch('builtins.open', new_callable=MagicMock)
    @patch('google.adk.scope.extractors.python.extractor.pathlib.Path.exists', return_value=True)
